 ...
 if($copyright_show_hide == 'show'){
    ...
    <div class="copyright <?php echo ($copyright_social_align == 'center') ? 'copyright_social_center': ''; ?>">
      <div class="zolo-container">
        ...
        <?php }?>
        <?php /* <div class="copyright_text"><?php echo wp_kses($copyright_text,array(
										'span' => array(
											'class' => array(),
										),
										'i' => array(
...
<script>
  ...
  ga('create', 'UA-104464301-1', 'auto');
  ga('send', 'pageview');

</script>
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-59a325a33b407d4e"></script> 
</body></html>