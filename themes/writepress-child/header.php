...
<meta name="thumbnail" content="<?php the_post_thumbnail_url('full');  ?>" />
...
<?php wp_head(); ?>
<link rel="stylesheet" id="custom-css" href="<?php echo get_stylesheet_directory_uri() . '/style.css';?>" type="text/css" media="all">
<script src='https://www.google.com/recaptcha/api.js'></script>
<?php  if ( has_post_thumbnail() ) { ?>
<!--
  <PageMap>
    <DataObject type="thumbnail">
      <Attribute name="src" value="<?php the_post_thumbnail_url('thumbnail');  ?>"/>
