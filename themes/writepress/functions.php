...
function writepress_excerpt_more($more) {
	...
	$post_continue_reading_modify = isset($writepress_data['post_continue_reading_modify']) ? $writepress_data['post_continue_reading_modify'] : __('Continue Reading','writepress');
